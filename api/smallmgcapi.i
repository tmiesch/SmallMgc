...
{
  SmallMGC_API_COMMAND_CONFIG_SMALLMGC_IP,
  ...
  SmallMGC_API_COMMAND_CONFIG_GATEWAY_IP,
  ...
  SmallMGC_API_COMMAND_CONFIG_SUBSCRIBER_GENERAL,
  SmallMGC_API_COMMAND_CONFIG_ADD_SUBSCRIBER,
  SmallMGC_API_COMMAND_CONFIG_REMOVE_SUBSCRIBER,
  SmallMGC_API_COMMAND_STATUS_SMALLMGC,
  SmallMGC_API_COMMAND_STATUS_GATEWAY,
  SmallMGC_API_COMMAND_STATUS_SUBSCRIBER,
  ...
  SmallMGC_API_AlARM_SMALLMGC,
  SmallMGC_API_AlARM_GATEWAY,
  SmallMGC_API_AlARM_SUBSCRIBER,
  SmallMGC_API_TEST_START,
  SmallMGC_API_TEST_STOP,
  SmallMGC_API_TEST_RESULT,

  SmallMGC_API_SEND_RAW,
  SmallMGC_API_RECEIVED_NOTIFY,
...
class SmallMGC_Api_TestReceivedMessage
{
public:
