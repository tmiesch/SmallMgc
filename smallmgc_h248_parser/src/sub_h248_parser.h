#ifndef SUBH248PARSER_INCLUDED
#define SUBH248PARSER_INCLUDED
...
class SUB_H248_Parser_Task: public Poco::Task::Task
{
public:
  SUB_H248_Parser_Task(class Poco::NotificationQueue& queue, class Poco::NotificationQueue& callQueue,
                       class Poco::NotificationQueue& gateQueue, class Poco::NotificationQueue& testQueue);
  virtual ~SUB_H248_Parser_Task();
...
class SUB_H248_Parser: public Poco::Util::Subsystem
	/// Sending and Receiving H248 Packets.
{
public:
	SUB_H248_Parser(Poco::TaskManager& tm, Poco::NotificationQueue& queue, Poco::NotificationQueue& callQueue,
                    Poco::NotificationQueue& gateQueue, class Poco::NotificationQueue& testQueue);
		/// Creates the H248 receiving thread.

	virtual ~SUB_H248_Parser();
