...
#ifndef SMALLMGCNCCCHANGEFAXFSM_H_
#define SMALLMGCNCCCHANGEFAXFSM_H_


#include "smallmgcnccfsm.h"

class SmallMGC_NCC_ChangeFaxFsm : public SmallMgc_NCC_Fsm
{
public:
  static SmallMGC_NCC_ChangeFaxFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_NCC_ChangeFaxFsm* s_instance;
   SmallMGC_NCC_ChangeFaxFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMgc_NCC_Fsm(database, adapter)
     {

     };
     SmallMGC_NCC_ChangeFaxFsm();
  virtual ~SmallMGC_NCC_ChangeFaxFsm();
...
#endif /* SMALLMGCNCCCHANGEFAXFSM_H_ */
