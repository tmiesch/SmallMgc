...
#ifndef SMALLMGCNCCINPROGRESSFSM_H_
#define SMALLMGCNCCINPROGRESSFSM_H_

#include "smallmgcnccfsm.h"

class SmallMGC_NCC_InProgressFsm : public SmallMgc_NCC_Fsm
{
public:
  static SmallMGC_NCC_InProgressFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_NCC_InProgressFsm* s_instance;
   SmallMGC_NCC_InProgressFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMgc_NCC_Fsm(database, adapter)
     {

     };
  SmallMGC_NCC_InProgressFsm();
  virtual
  ~SmallMGC_NCC_InProgressFsm();
...
#endif /* SMALLMGCNCCINPROGRESSFSM_H_ */
