...
#ifndef SMALLMGCNCCMODEMESTABLISHEDFSM_H_
#define SMALLMGCNCCMODEMESTABLISHEDFSM_H_

#include "smallmgcnccfsm.h"

class SmallMGC_NCC_ModemEstablishedFsm : public SmallMgc_NCC_Fsm
{
public:
  static SmallMGC_NCC_ModemEstablishedFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_NCC_ModemEstablishedFsm* s_instance;
   SmallMGC_NCC_ModemEstablishedFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMgc_NCC_Fsm(database, adapter)
     {

     };
  SmallMGC_NCC_ModemEstablishedFsm();
  virtual ~SmallMGC_NCC_ModemEstablishedFsm();
...
#endif /* SMALLMGCNCCMODEMESTABLISHEDFSM_H_ */
