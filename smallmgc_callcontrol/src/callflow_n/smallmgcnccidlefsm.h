...
#ifndef SMALLMGCNCCIDLEFSM_H_
#define SMALLMGCNCCIDLEFSM_H_

#include "smallmgcnccfsm.h"

class SmallMGC_NCC_IdleFsm : public SmallMgc_NCC_Fsm
{
public:
  static SmallMGC_NCC_IdleFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_NCC_IdleFsm* s_instance;
   SmallMGC_NCC_IdleFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMgc_NCC_Fsm(database, adapter)
     {

     };

   SmallMGC_NCC_IdleFsm();
   virtual ~SmallMGC_NCC_IdleFsm();
