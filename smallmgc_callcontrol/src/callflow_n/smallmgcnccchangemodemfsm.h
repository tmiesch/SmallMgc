...
#ifndef SMALLMGCNCCCHANGEMODEMFSM_H_
#define SMALLMGCNCCCHANGEMODEMFSM_H_

#include "smallmgcnccfsm.h"

class SmallMGC_NCC_ChangeModemFsm : public SmallMgc_NCC_Fsm
{
public:
  static SmallMGC_NCC_ChangeModemFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_NCC_ChangeModemFsm* s_instance;
   SmallMGC_NCC_ChangeModemFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMgc_NCC_Fsm(database, adapter)
     {

     };
     SmallMGC_NCC_ChangeModemFsm();
  virtual ~SmallMGC_NCC_ChangeModemFsm();
...
#endif /* SMALLMGCNCCCHANGEMODEMFSM_H_ */
