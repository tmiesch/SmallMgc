...
#ifndef SMALLMGCNCCRELEASINGFSM_H_
#define SMALLMGCNCCRELEASINGFSM_H_

#include "smallmgcnccfsm.h"

class SmallMGC_NCC_ReleasingFsm : public SmallMgc_NCC_Fsm
{
public:
  static SmallMGC_NCC_ReleasingFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_NCC_ReleasingFsm* s_instance;
   SmallMGC_NCC_ReleasingFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMgc_NCC_Fsm(database, adapter)
     {

     };
     SmallMGC_NCC_ReleasingFsm();
  virtual ~SmallMGC_NCC_ReleasingFsm();
...
#endif /* SMALLMGCNCCRELEASINGFSM_H_ */
