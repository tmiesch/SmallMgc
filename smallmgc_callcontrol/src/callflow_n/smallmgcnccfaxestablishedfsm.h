...
#ifndef SMALLMGCNCCFAXESTABLISHEDFSM_H_
#define SMALLMGCNCCFAXESTABLISHEDFSM_H_

#include "smallmgcnccfsm.h"

class SmallMGC_NCC_FaxEstablishedFsm : public SmallMgc_NCC_Fsm
{
public:
  static SmallMGC_NCC_FaxEstablishedFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_NCC_FaxEstablishedFsm* s_instance;
   SmallMGC_NCC_FaxEstablishedFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMgc_NCC_Fsm(database, adapter)
     {

     };
  SmallMGC_NCC_FaxEstablishedFsm();
  virtual ~SmallMGC_NCC_FaxEstablishedFsm();
...
#endif /* SMALLMGCNCCFAXESTABLISHEDFSM_H_ */
