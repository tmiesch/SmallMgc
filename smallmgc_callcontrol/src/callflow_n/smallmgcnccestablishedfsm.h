...
#ifndef SMALLMGCNCCESTABLISHEDFSM_H_
#define SMALLMGCNCCESTABLISHEDFSM_H_

#include "smallmgcnccfsm.h"

class SmallMGC_NCC_EstablishedFsm : public SmallMgc_NCC_Fsm
{
public:
  static SmallMGC_NCC_EstablishedFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_NCC_EstablishedFsm* s_instance;
   SmallMGC_NCC_EstablishedFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMgc_NCC_Fsm(database, adapter)
     {

     };
  SmallMGC_NCC_EstablishedFsm();
  virtual ~SmallMGC_NCC_EstablishedFsm();
...
#endif /* SMALLMGCNCCESTABLISHEDFSM_H_ */
