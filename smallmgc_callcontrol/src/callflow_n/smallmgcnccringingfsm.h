...
#ifndef SMALLMGCNCCRINGINGFSM_H_
#define SMALLMGCNCCRINGINGFSM_H_

#include "smallmgcnccfsm.h"

class SmallMGC_NCC_RingingFsm : public SmallMgc_NCC_Fsm
{
public:
  static SmallMGC_NCC_RingingFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_NCC_RingingFsm* s_instance;
   SmallMGC_NCC_RingingFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMgc_NCC_Fsm(database, adapter)
     {

     };
  SmallMGC_NCC_RingingFsm();
  virtual
  ~SmallMGC_NCC_RingingFsm();
