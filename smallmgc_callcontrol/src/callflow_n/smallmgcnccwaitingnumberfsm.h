...
#ifndef SMALLMGCNCCWAITINGNUMBERFSM_H_
#define SMALLMGCNCCWAITINGNUMBERFSM_H_

#include "smallmgcnccfsm.h"

class SmallMGC_NCC_WaitingNumberFsm : public SmallMgc_NCC_Fsm
{
public:
  static SmallMGC_NCC_WaitingNumberFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_NCC_WaitingNumberFsm* s_instance;
   SmallMGC_NCC_WaitingNumberFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMgc_NCC_Fsm(database, adapter)
     {

     };

     SmallMGC_NCC_WaitingNumberFsm();
  virtual ~SmallMGC_NCC_WaitingNumberFsm();
public:
...
#endif /* SMALLMGCNCCWAITINGNUMBERFSM_H_ */
