...
#ifndef SMALLMGCGCCMODEMESTABLISHEDFSM_H_
#define SMALLMGCGCCMODEMESTABLISHEDFSM_H_

#include "smallmgcgccfsm.h"

class SmallMGC_GCC_ModemEstablishedFsm : public SmallMGC_GCC_Fsm
{
public:
  static SmallMGC_GCC_ModemEstablishedFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_GCC_ModemEstablishedFsm* s_instance;
   SmallMGC_GCC_ModemEstablishedFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMGC_GCC_Fsm(database, adapter)
     {

     };

     SmallMGC_GCC_ModemEstablishedFsm();
  virtual ~SmallMGC_GCC_ModemEstablishedFsm();
public:
...
#endif /* SMALLMGCGCCMODEMESTABLISHEDFSM_H_ */
