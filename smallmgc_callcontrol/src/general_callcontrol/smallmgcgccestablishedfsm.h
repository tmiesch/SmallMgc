...
#ifndef SMALLMGCGCCESTABLISHEDFSM_H_
#define SMALLMGCGCCESTABLISHEDFSM_H_

#include "smallmgcgccfsm.h"

class SmallMGC_GCC_EstablishedFsm : public SmallMGC_GCC_Fsm
{
public:
  static SmallMGC_GCC_EstablishedFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_GCC_EstablishedFsm* s_instance;
   SmallMGC_GCC_EstablishedFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMGC_GCC_Fsm(database, adapter)
     {

     };
  SmallMGC_GCC_EstablishedFsm();
  virtual ~SmallMGC_GCC_EstablishedFsm();
...
#endif /* SMALLMGCGCCESTABLISHEDFSM_H_ */
