...
#ifndef SMALLMGCGCCRINGINGFSM_H_
#define SMALLMGCGCCRINGINGFSM_H_

#include "smallmgcgccfsm.h"

class SmallMGC_GCC_RingingFsm : public SmallMGC_GCC_Fsm
{
public:
  static SmallMGC_GCC_RingingFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_GCC_RingingFsm* s_instance;
   SmallMGC_GCC_RingingFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMGC_GCC_Fsm(database, adapter)
     {

     };

  SmallMGC_GCC_RingingFsm();
  virtual ~SmallMGC_GCC_RingingFsm();
public:
...
#endif /* SMALLMGCGCCRINGINGFSM_H_ */
