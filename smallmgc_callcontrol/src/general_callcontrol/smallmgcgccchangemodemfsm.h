...
#ifndef SMALLMGCGCCCHANGEMODEMFSM_H_
#define SMALLMGCGCCCHANGEMODEMFSM_H_

#include "smallmgcgccfsm.h"

class SmallMGC_GCC_ChangeModemFsm : public SmallMGC_GCC_Fsm
{
public:
  static SmallMGC_GCC_ChangeModemFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_GCC_ChangeModemFsm* s_instance;
   SmallMGC_GCC_ChangeModemFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMGC_GCC_Fsm(database, adapter)
     {

     };

     SmallMGC_GCC_ChangeModemFsm();
  virtual ~SmallMGC_GCC_ChangeModemFsm();
public:
...
#endif /* SMALLMGCGCCCHANGEMODEMFSM_H_ */
