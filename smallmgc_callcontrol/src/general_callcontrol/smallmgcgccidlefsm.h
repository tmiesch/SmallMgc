...
#ifndef SMALLMGCGCCIDLEFSM_H_
#define SMALLMGCGCCIDLEFSM_H_

#include "smallmgcgccfsm.h"

class SmallMGC_GCC_IdleFsm : public SmallMGC_GCC_Fsm
{
public:
  static SmallMGC_GCC_IdleFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_GCC_IdleFsm* s_instance;
   SmallMGC_GCC_IdleFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMGC_GCC_Fsm(database, adapter)
     {

     };

  SmallMGC_GCC_IdleFsm();
  virtual
  ~SmallMGC_GCC_IdleFsm();
