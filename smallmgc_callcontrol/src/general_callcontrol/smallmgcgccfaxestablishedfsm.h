...
#ifndef SMALLMGCGCCFAXESTABLISHEDFSM_H_
#define SMALLMGCGCCFAXESTABLISHEDFSM_H_

#include "smallmgcgccfsm.h"

class SmallMGC_GCC_FaxEstablishedFsm : public SmallMGC_GCC_Fsm
{
public:
  static SmallMGC_GCC_FaxEstablishedFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_GCC_FaxEstablishedFsm* s_instance;
   SmallMGC_GCC_FaxEstablishedFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMGC_GCC_Fsm(database, adapter)
     {

     };

     SmallMGC_GCC_FaxEstablishedFsm();
  virtual ~SmallMGC_GCC_FaxEstablishedFsm();
public:
...
#endif /* SMALLMGCGCCFAXESTABLISHEDFSM_H_ */
