...
#ifndef SMALLMGCETSIRINGINGFSM_H_
#define SMALLMGCETSIRINGINGFSM_H_

#include "smallmgcetsifsm.h"

class SmallMGC_ETSI_RingingFsm : public SmallMgc_ETSI_Fsm
{
public:
  static SmallMGC_ETSI_RingingFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_ETSI_RingingFsm* s_instance;
   SmallMGC_ETSI_RingingFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMgc_ETSI_Fsm(database, adapter)
     {

     };
     SmallMGC_ETSI_RingingFsm();
  virtual
  ~SmallMGC_ETSI_RingingFsm();
