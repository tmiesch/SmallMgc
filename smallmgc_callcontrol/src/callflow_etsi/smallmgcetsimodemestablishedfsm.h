...
#ifndef SMALLMGCETSIMODEMESTABLISHEDFSM_H_
#define SMALLMGCETSIMODEMESTABLISHEDFSM_H_

#include "smallmgcetsifsm.h"

class SmallMGC_ETSI_ModemEstablishedFsm : public SmallMgc_ETSI_Fsm
{
public:
  static SmallMGC_ETSI_ModemEstablishedFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_ETSI_ModemEstablishedFsm* s_instance;
   SmallMGC_ETSI_ModemEstablishedFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMgc_ETSI_Fsm(database, adapter)
     {

     };
     SmallMGC_ETSI_ModemEstablishedFsm();
  virtual ~SmallMGC_ETSI_ModemEstablishedFsm();
