...
class SmallMGC_ETSI_StartedFsm : public SmallMgc_ETSI_Fsm
{
public:
  static SmallMGC_ETSI_StartedFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_ETSI_StartedFsm* s_instance;
   SmallMGC_ETSI_StartedFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMgc_ETSI_Fsm(database, adapter)
     {

     };

     SmallMGC_ETSI_StartedFsm();
  virtual ~SmallMGC_ETSI_StartedFsm();
public:
