...
#ifndef SMALLMGCETSIRELEASINGFSM_H_
#define SMALLMGCETSIRELEASINGFSM_H_

#include "smallmgcetsifsm.h"

class SmallMGC_ETSI_ReleasingFsm : public SmallMgc_ETSI_Fsm
{
public:
  static SmallMGC_ETSI_ReleasingFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_ETSI_ReleasingFsm* s_instance;
   SmallMGC_ETSI_ReleasingFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMgc_ETSI_Fsm(database, adapter)
     {

     };
     SmallMGC_ETSI_ReleasingFsm();
  virtual ~SmallMGC_ETSI_ReleasingFsm();
