...
#ifndef SMALLMGCETSIINPROGRESSFSM_H_
#define SMALLMGCETSIINPROGRESSFSM_H_

#include "smallmgcetsifsm.h"

class SmallMGC_ETSI_InProgressFsm : public SmallMgc_ETSI_Fsm
{
public:
  static SmallMGC_ETSI_InProgressFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_ETSI_InProgressFsm* s_instance;
   SmallMGC_ETSI_InProgressFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMgc_ETSI_Fsm(database, adapter)
     {

     };
     SmallMGC_ETSI_InProgressFsm();
  virtual
  ~SmallMGC_ETSI_InProgressFsm();
