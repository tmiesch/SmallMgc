...
#ifndef SMALLMGCETSICHANGEMODEMFSM_H_
#define SMALLMGCETSICHANGEMODEMFSM_H_

#include "smallmgcetsifsm.h"

class SmallMGC_ETSI_ChangeModemFsm : public SmallMgc_ETSI_Fsm
{
public:
  static SmallMGC_ETSI_ChangeModemFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_ETSI_ChangeModemFsm* s_instance;
   SmallMGC_ETSI_ChangeModemFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMgc_ETSI_Fsm(database, adapter)
     {

     };
     SmallMGC_ETSI_ChangeModemFsm();
  virtual ~SmallMGC_ETSI_ChangeModemFsm();
...
#endif /* SMALLMGCETSICHANGEMODEMFSM_H_ */
