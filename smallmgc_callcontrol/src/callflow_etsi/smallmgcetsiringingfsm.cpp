...
#include "smallmgcetsiringingfsm.h"
...
SmallMGC_ETSI_RingingFsm::SmallMGC_ETSI_RingingFsm()
{
...
SmallMGC_ETSI_RingingFsm*  SmallMGC_ETSI_RingingFsm::s_instance = 0;

SmallMGC_ETSI_RingingFsm*  SmallMGC_ETSI_RingingFsm::instance(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter)
{
  if(s_instance == 0)
  {
    Poco::UInt32 xcode;
    s_instance = new SmallMGC_ETSI_RingingFsm(database, adapter);
  }
  return s_instance;
}


Poco::UInt32 SmallMGC_ETSI_RingingFsm::startCall(class H248STACK_Call* call, Poco::UInt32 transactionId, std::string& term )
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_RingingFsm::modifyReply(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
  ...
  if (direction == SmallMGC_OUT)
  {
    ...
    call->m_outleg = SmallMGC_ETSI_EstablishedFsm::instance();
  ...
  else
  {
    ...
    call->m_inleg = SmallMGC_ETSI_EstablishedFsm::instance();
...
Poco::UInt32 SmallMGC_ETSI_RingingFsm::modifyReply(class H248STACK_Call* call, enum SmallMGCLegDirection direction, std::string& localSDP)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_RingingFsm::addReply(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_RingingFsm::addReply(class H248STACK_Call* call, enum SmallMGCLegDirection direction, std::string& localSDP)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_RingingFsm::subtractReply(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_RingingFsm::notifyDigit(class H248STACK_Call* call, enum SmallMGCLegDirection direction, std::string& digits)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_RingingFsm::notifyOffHook(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
  ...
  if (direction == SmallMGC_IN)
  {
     ...
     call->m_incoming->m_outstandingMessage =
    	 SmallMGC_EtsiMessageBuilder::buildModifySR(call->m_incoming->m_outstandingReplyTransactionId, call->m_incoming->m_contextId,call->m_incoming->m_physical, call->m_incoming->m_ephemeral,call->m_incoming->m_remoteDescriptor, m_database->getEventRequestId());
...
Poco::UInt32 SmallMGC_ETSI_RingingFsm::notifyOnHook(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_RingingFsm::notifyTone(class H248STACK_Call* call, enum SmallMGCLegDirection direction, std::string& tones)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_RingingFsm::notifyFlashHook(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_RingingFsm::timerExpiry(class H248STACK_Call* call, enum SmallMGCLegDirection direction, Poco::UInt32 transactionId,std::string& term)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_RingingFsm::startCallReq(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_RingingFsm::bearerInformationReq(class H248STACK_Call* call, enum SmallMGCLegDirection direction, std::string& sdp)
{
  Poco::UInt32 xcode = 0;
  ...
  if (direction == SmallMGC_OUT)
  {
       ...
       call->m_outgoing->m_outstandingReplyTransactionId = m_database->getNextTransactionId();
       call->m_outgoing->m_outstandingMessage =
    	   SmallMGC_EtsiMessageBuilder::buildModifyLocalSR(call->m_outgoing->m_outstandingReplyTransactionId,
...
Poco::UInt32 SmallMGC_ETSI_RingingFsm::establishedReq(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_RingingFsm::releaseReq(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_RingingFsm::ringingReq(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_RingingFsm::switchToT38Req(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_RingingFsm::switchToModemReq(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_RingingFsm::setup(class H248STACK_Call* call, enum SmallMGCLegDirection direction, enum SmallMGCIsdnBABearer bearer)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_RingingFsm::information(class H248STACK_Call* call, enum SmallMGCLegDirection direction, std::string& number)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_RingingFsm::alerting(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_RingingFsm::connect(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_RingingFsm::connectAck(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_RingingFsm::disconnect(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_RingingFsm::release(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_RingingFsm::releaseComplete(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
 ...
 Poco::UInt32 SmallMGC_ETSI_RingingFsm::sendToMg(std::string const& msg)
 {
   // for reply messages
 }
