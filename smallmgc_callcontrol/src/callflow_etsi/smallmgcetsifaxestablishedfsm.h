...
#ifndef SMALLMGCETSIFAXESTABLISHEDFSM_H_
#define SMALLMGCETSIFAXESTABLISHEDFSM_H_

#include "smallmgcetsifsm.h"

class SmallMGC_ETSI_FaxEstablishedFsm : public SmallMgc_ETSI_Fsm
{
public:
  static SmallMGC_ETSI_FaxEstablishedFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_ETSI_FaxEstablishedFsm* s_instance;
   SmallMGC_ETSI_FaxEstablishedFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMgc_ETSI_Fsm(database, adapter)
     {

     };
     SmallMGC_ETSI_FaxEstablishedFsm();
  virtual ~SmallMGC_ETSI_FaxEstablishedFsm();
...
#endif /* SMALLMGCETSIFAXESTABLISHEDFSM_H_ */
