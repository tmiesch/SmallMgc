...
#ifndef SMALLMGCETSIIDLEFSM_H_
#define SMALLMGCETSIDLEFSM_H_

#include "smallmgcetsifsm.h"

class SmallMGC_ETSI_IdleFsm : public SmallMgc_ETSI_Fsm
{
public:
  static SmallMGC_ETSI_IdleFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_ETSI_IdleFsm* s_instance;
   SmallMGC_ETSI_IdleFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMgc_ETSI_Fsm(database, adapter)
     {

     };

     SmallMGC_ETSI_IdleFsm();
   virtual ~SmallMGC_ETSI_IdleFsm();
