...
#ifndef SMALLMGCETSICHANGEFAXFSM_H_
#define SMALLMGCETSICHANGEFAXFSM_H_


#include "smallmgcetsifsm.h"

class SmallMGC_ETSI_ChangeFaxFsm : public SmallMgc_ETSI_Fsm
{
public:
  static SmallMGC_ETSI_ChangeFaxFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_ETSI_ChangeFaxFsm* s_instance;
   SmallMGC_ETSI_ChangeFaxFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMgc_ETSI_Fsm(database, adapter)
     {

     };
     SmallMGC_ETSI_ChangeFaxFsm();
  virtual ~SmallMGC_ETSI_ChangeFaxFsm();
...
#endif /* SMALLMGCETSICHANGEFAXFSM_H_ */
