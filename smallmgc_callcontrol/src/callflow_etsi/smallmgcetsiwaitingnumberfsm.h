...
#ifndef SMALLMGCETSIWAITINGNUMBERFSM_H_
#define SMALLMGCETSIWAITINGNUMBERFSM_H_

#include "smallmgcetsifsm.h"

class SmallMGC_ETSI_WaitingNumberFsm : public SmallMgc_ETSI_Fsm
{
public:
  static SmallMGC_ETSI_WaitingNumberFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_ETSI_WaitingNumberFsm* s_instance;
   SmallMGC_ETSI_WaitingNumberFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMgc_ETSI_Fsm(database, adapter)
     {

     };

     SmallMGC_ETSI_WaitingNumberFsm();
  virtual ~SmallMGC_ETSI_WaitingNumberFsm();
public:
