...
SmallMGC_ETSI_ChangeModemFsm::SmallMGC_ETSI_ChangeModemFsm()
{
...
SmallMGC_ETSI_ChangeModemFsm*  SmallMGC_ETSI_ChangeModemFsm::s_instance = 0;

SmallMGC_ETSI_ChangeModemFsm*  SmallMGC_ETSI_ChangeModemFsm::instance(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter)
{
  if(s_instance == 0)
  {
    Poco::UInt32 xcode;
    s_instance = new SmallMGC_ETSI_ChangeModemFsm(database, adapter);
  }
  return s_instance;
}


Poco::UInt32 SmallMGC_ETSI_ChangeModemFsm::startCall(class H248STACK_Call* call, Poco::UInt32 transactionId, std::string& term )
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_ChangeModemFsm::modifyReply(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_ChangeModemFsm::modifyReply(class H248STACK_Call* call, enum SmallMGCLegDirection direction, std::string& localSDP)
{
  Poco::UInt32 xcode = 0;
  ...
  if (direction == SmallMGC_OUT)
  {
    ...
    if (call->m_releaser == H248STACK_NotReleased)
    {
      ...
      call->m_outleg = SmallMGC_ETSI_ModemEstablishedFsm::instance();
    }
    else
    {
    }
  ...
  else
  {
    ...
    {
      m_adapter->bearerInformationInd(call, direction,localSDP);
      call->m_inleg = SmallMGC_ETSI_ModemEstablishedFsm::instance();
    }
  }
  return xcode;

}
Poco::UInt32 SmallMGC_ETSI_ChangeModemFsm::addReply(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_ChangeModemFsm::addReply(class H248STACK_Call* call, enum SmallMGCLegDirection direction, std::string& localSDP)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_ChangeModemFsm::subtractReply(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_ChangeModemFsm::notifyDigit(class H248STACK_Call* call, enum SmallMGCLegDirection direction, std::string& digits)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_ChangeModemFsm::notifyOffHook(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
  Application::instance().logger().trace(" State: HCC ChangeModem;  Event:  notify off hook\n");
}
Poco::UInt32 SmallMGC_ETSI_ChangeModemFsm::notifyOnHook(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_ChangeModemFsm::notifyTone(class H248STACK_Call* call, enum SmallMGCLegDirection direction, std::string& tones)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_ChangeModemFsm::notifyFlashHook(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_ChangeModemFsm::timerExpiry(class H248STACK_Call* call, enum SmallMGCLegDirection direction, Poco::UInt32 transactionId,std::string& term)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_ChangeModemFsm::startCallReq(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_ChangeModemFsm::bearerInformationReq(class H248STACK_Call* call, enum SmallMGCLegDirection direction, std::string& sdp)
{
  Poco::UInt32 xcode = 0;
  ...
  if (direction == SmallMGC_OUT)
  {
    ...
    call->m_outgoing->m_outstandingMessage =
    	SmallMGC_EtsiMessageBuilder::buildModifyModem(call->m_outgoing->m_outstandingReplyTransactionId, call->m_outgoing->m_contextId,
  ...
  else
  {
    ...
    call->m_incoming->m_outstandingReplyTransactionId = m_database->getNextTransactionId();
    call->m_incoming->m_outstandingMessage =
    	SmallMGC_EtsiMessageBuilder::buildModifyModem(call->m_incoming->m_outstandingReplyTransactionId, call->m_incoming->m_contextId,
...
Poco::UInt32 SmallMGC_ETSI_ChangeModemFsm::establishedReq(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
  Application::instance().logger().trace(" State: HCC ChangeModem;  Event:  ChangeModem req\n");
  return xcode;
}
Poco::UInt32 SmallMGC_ETSI_ChangeModemFsm::releaseReq(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_ChangeModemFsm::ringingReq(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
  Application::instance().logger().trace(" State: HCC ChangeModem;  Event:  ringing req\n");
  return xcode;
}
Poco::UInt32 SmallMGC_ETSI_ChangeModemFsm::switchToT38Req(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_ChangeModemFsm::switchToModemReq(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_ChangeModemFsm::setup(class H248STACK_Call* call, enum SmallMGCLegDirection direction, enum SmallMGCIsdnBABearer bearer)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_ChangeModemFsm::information(class H248STACK_Call* call, enum SmallMGCLegDirection direction, std::string& number)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_ChangeModemFsm::alerting(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_ChangeModemFsm::connect(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_ChangeModemFsm::connectAck(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_ChangeModemFsm::disconnect(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_ChangeModemFsm::release(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_ChangeModemFsm::releaseComplete(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
 ...
 Poco::UInt32 SmallMGC_ETSI_ChangeModemFsm::sendToMg(std::string const& msg)
 {
   // for reply messages
 }
