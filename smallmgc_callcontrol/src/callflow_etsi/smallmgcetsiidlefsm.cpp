...
SmallMGC_ETSI_IdleFsm::SmallMGC_ETSI_IdleFsm()
{
...
SmallMGC_ETSI_IdleFsm*  SmallMGC_ETSI_IdleFsm::s_instance = 0;

SmallMGC_ETSI_IdleFsm*  SmallMGC_ETSI_IdleFsm::instance(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter)
{
  if(s_instance == 0)
  {
    Poco::UInt32 xcode;
    s_instance = new SmallMGC_ETSI_IdleFsm(database, adapter);
  }
  return s_instance;
}


Poco::UInt32 SmallMGC_ETSI_IdleFsm::startCall(class H248STACK_Call* call, Poco::UInt32 transactionId, std::string& term )
{
  Poco::UInt32 xcode = 0;
  ...
  call->m_outgoing->m_outstandingMessage = SmallMGC_EtsiMessageBuilder::buildModifyOffHookDialTone(call->m_outgoing->m_outstandingReplyTransactionId, term,m_database->getEventRequestId());
...
Poco::UInt32 SmallMGC_ETSI_IdleFsm::modifyReply(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_IdleFsm::modifyReply(class H248STACK_Call* call, enum SmallMGCLegDirection direction, std::string& localSDP)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_IdleFsm::addReply(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_IdleFsm::addReply(class H248STACK_Call* call, enum SmallMGCLegDirection direction, std::string& localSDP)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_IdleFsm::subtractReply(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_IdleFsm::notifyDigit(class H248STACK_Call* call, enum SmallMGCLegDirection direction, std::string& digits)
{
  Poco::UInt32 xcode = 0;
  ...
  call->m_outleg = SmallMGC_ETSI_WaitingNumberFsm::instance();
  return xcode;
}

Poco::UInt32 SmallMGC_ETSI_IdleFsm::notifyOffHook(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_IdleFsm::notifyOnHook(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_IdleFsm::notifyTone(class H248STACK_Call* call, enum SmallMGCLegDirection direction, std::string& tones)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_IdleFsm::notifyFlashHook(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
  Application::instance().logger().trace(" State: HCC IDLE;  Event:  notify flash hook\n");
  return xcode;
}
Poco::UInt32 SmallMGC_ETSI_IdleFsm::timerExpiry(class H248STACK_Call* call, enum SmallMGCLegDirection direction, Poco::UInt32 transactionId,std::string& term)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_IdleFsm::startCallReq(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
  Application::instance().logger().trace(" State: HCC IDLE;  Event:  start call req\n");
  call->m_inleg = SmallMGC_ETSI_StartedFsm::instance();
  call->m_incoming->m_dialledDigits.clear();
  return xcode;

}
Poco::UInt32 SmallMGC_ETSI_IdleFsm::bearerInformationReq(class H248STACK_Call* call, enum SmallMGCLegDirection direction, std::string& sdp)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_IdleFsm::establishedReq(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_IdleFsm::releaseReq(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_IdleFsm::ringingReq(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_IdleFsm::switchToT38Req(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_IdleFsm::switchToModemReq(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_IdleFsm::setup(class H248STACK_Call* call, enum SmallMGCLegDirection direction, enum SmallMGCIsdnBABearer bearer)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_IdleFsm::information(class H248STACK_Call* call, enum SmallMGCLegDirection direction, std::string& number)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_IdleFsm::alerting(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_IdleFsm::connect(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_IdleFsm::connectAck(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_IdleFsm::disconnect(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_IdleFsm::release(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_ETSI_IdleFsm::releaseComplete(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
 ...
 Poco::UInt32 SmallMGC_ETSI_IdleFsm::sendToMg(std::string const& msg)
 {
   // for reply messages
 }
