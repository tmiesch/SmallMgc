...
SmallMGC_HCC_ChangeFaxFsm::SmallMGC_HCC_ChangeFaxFsm()
{
...
SmallMGC_HCC_ChangeFaxFsm*  SmallMGC_HCC_ChangeFaxFsm::s_instance = 0;

SmallMGC_HCC_ChangeFaxFsm*  SmallMGC_HCC_ChangeFaxFsm::instance(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter)
{
  if(s_instance == 0)
  {
    Poco::UInt32 xcode;
    s_instance = new SmallMGC_HCC_ChangeFaxFsm(database, adapter);
  }
  return s_instance;
}


Poco::UInt32 SmallMGC_HCC_ChangeFaxFsm::startCall(class H248STACK_Call* call, Poco::UInt32 transactionId, std::string& term )
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_HCC_ChangeFaxFsm::modifyReply(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_HCC_ChangeFaxFsm::modifyReply(class H248STACK_Call* call, enum SmallMGCLegDirection direction, std::string& localSDP)
{
  Poco::UInt32 xcode = 0;
  ...
  if (direction == SmallMGC_OUT)
  {
    ...
    if (call->m_releaser == H248STACK_NotReleased)
    {
      if (call->m_outgoing->m_modifyReceived > 0)
      {
        ...
        call->m_outleg = SmallMGC_HCC_FaxEstablishedFsm::instance();
      }
      else
      {
      ...
      call->m_outgoing->m_modifyReceived++;
    }
    else
    {
    }
  ...
  else
  {
    ...
    if (call->m_releaser == H248STACK_NotReleased)
    {
      ...
      {
        m_adapter->faxEstablishedInd(call, direction);
        call->m_inleg = SmallMGC_HCC_FaxEstablishedFsm::instance();
      }
      else
      {
      ...
      call->m_incoming->m_modifyReceived++;
    }
  }
  return xcode;

}
Poco::UInt32 SmallMGC_HCC_ChangeFaxFsm::addReply(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_HCC_ChangeFaxFsm::addReply(class H248STACK_Call* call, enum SmallMGCLegDirection direction, std::string& localSDP)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_HCC_ChangeFaxFsm::subtractReply(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_HCC_ChangeFaxFsm::notifyDigit(class H248STACK_Call* call, enum SmallMGCLegDirection direction, std::string& digits)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_HCC_ChangeFaxFsm::notifyOffHook(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
  Application::instance().logger().trace(" State: HCC ChangeFax;  Event:  notify off hook\n");
}
Poco::UInt32 SmallMGC_HCC_ChangeFaxFsm::notifyOnHook(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_HCC_ChangeFaxFsm::notifyTone(class H248STACK_Call* call, enum SmallMGCLegDirection direction, std::string& tones)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_HCC_ChangeFaxFsm::notifyFlashHook(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_HCC_ChangeFaxFsm::timerExpiry(class H248STACK_Call* call, enum SmallMGCLegDirection direction, Poco::UInt32 transactionId,std::string& term)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_HCC_ChangeFaxFsm::startCallReq(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_HCC_ChangeFaxFsm::bearerInformationReq(class H248STACK_Call* call, enum SmallMGCLegDirection direction, std::string& sdp)
{
  Poco::UInt32 xcode = 0;
  ...
  if (direction == SmallMGC_OUT)
  {
    ...
    {
      call->m_outgoing->m_outstandingMessage =
          SmallMGC_HMessageBuilder::buildModifyLocalChooseFax(call->m_outgoing->m_outstandingReplyTransactionId, call->m_outgoing->m_contextId,
          call->m_outgoing->m_physical, call->m_outgoing->m_ephemeral, call->m_outgoing->m_remoteDescriptor, m_database->getEventRequestId());
    }
    else
    {
      call->m_outgoing->m_outstandingMessage =
    	  SmallMGC_HMessageBuilder::buildModifyWithoutLocalFax(call->m_outgoing->m_outstandingReplyTransactionId, call->m_outgoing->m_contextId,
    	  call->m_outgoing->m_physical, call->m_outgoing->m_ephemeral, call->m_outgoing->m_remoteDescriptor, m_database->getEventRequestId());
    }
    m_adapter->sendToMg(call->m_outgoing->m_gateway->mgIPAddress, call->m_outgoing->m_outstandingMessage);
    call->m_outgoing->m_timer = m_adapter->startTimer(1000,call->m_outgoing->m_gateway->mgIPAddress,call->m_outgoing->m_outstandingReplyTransactionId, "", call->m_outgoing->m_physical);
  ...
  else
  {
    ...
    {
    call->m_incoming->m_outstandingMessage =
        SmallMGC_HMessageBuilder::buildModifyLocalChooseFax(call->m_incoming->m_outstandingReplyTransactionId, call->m_incoming->m_contextId,
                            call->m_incoming->m_physical, call->m_incoming->m_ephemeral, call->m_incoming->m_remoteDescriptor, m_database->getEventRequestId());
    }
    else
    {
      call->m_incoming->m_outstandingMessage =
        SmallMGC_HMessageBuilder::buildModifyWithoutLocalFax(call->m_incoming->m_outstandingReplyTransactionId, call->m_incoming->m_contextId,
        call->m_incoming->m_physical, call->m_incoming->m_ephemeral, call->m_incoming->m_remoteDescriptor, m_database->getEventRequestId());
...
Poco::UInt32 SmallMGC_HCC_ChangeFaxFsm::establishedReq(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
  Application::instance().logger().trace(" State: HCC ChangeFax;  Event:  ChangeFax req\n");
  return xcode;
}
Poco::UInt32 SmallMGC_HCC_ChangeFaxFsm::releaseReq(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_HCC_ChangeFaxFsm::ringingReq(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
  Application::instance().logger().trace(" State: HCC ChangeFax;  Event:  ringing req\n");
  return xcode;
}
Poco::UInt32 SmallMGC_HCC_ChangeFaxFsm::switchToT38Req(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_HCC_ChangeFaxFsm::switchToModemReq(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_HCC_ChangeFaxFsm::setup(class H248STACK_Call* call, enum SmallMGCLegDirection direction, enum SmallMGCIsdnBABearer bearer)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_HCC_ChangeFaxFsm::information(class H248STACK_Call* call, enum SmallMGCLegDirection direction, std::string& number)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_HCC_ChangeFaxFsm::alerting(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_HCC_ChangeFaxFsm::connect(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_HCC_ChangeFaxFsm::connectAck(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_HCC_ChangeFaxFsm::disconnect(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_HCC_ChangeFaxFsm::release(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_HCC_ChangeFaxFsm::releaseComplete(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
 ...
 Poco::UInt32 SmallMGC_HCC_ChangeFaxFsm::sendToMg(std::string const& msg)
 {
   // for reply messages
 }
