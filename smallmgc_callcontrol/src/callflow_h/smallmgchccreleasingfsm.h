...
#ifndef SMALLMGCHCCRELEASINGFSM_H_
#define SMALLMGCHCCRELEASINGFSM_H_

#include "smallmgchccfsm.h"

class SmallMGC_HCC_ReleasingFsm : public SmallMgc_HCC_Fsm
{
public:
  static SmallMGC_HCC_ReleasingFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_HCC_ReleasingFsm* s_instance;
   SmallMGC_HCC_ReleasingFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMgc_HCC_Fsm(database, adapter)
     {

     };
     SmallMGC_HCC_ReleasingFsm();
  virtual ~SmallMGC_HCC_ReleasingFsm();
...
#endif /* SMALLMGCHCCRELEASINGFSM_H_ */
