...
#ifndef SMALLMGCHCCMODEMESTABLISHEDFSM_H_
#define SMALLMGCHCCMODEMESTABLISHEDFSM_H_

#include "smallmgchccfsm.h"

class SmallMGC_HCC_ModemEstablishedFsm : public SmallMgc_HCC_Fsm
{
public:
  static SmallMGC_HCC_ModemEstablishedFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_HCC_ModemEstablishedFsm* s_instance;
   SmallMGC_HCC_ModemEstablishedFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMgc_HCC_Fsm(database, adapter)
     {

     };
  SmallMGC_HCC_ModemEstablishedFsm();
  virtual ~SmallMGC_HCC_ModemEstablishedFsm();
...
#endif /* SMALLMGCHCCMODEMESTABLISHEDFSM_H_ */
