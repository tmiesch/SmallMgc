...
#ifndef SMALLMGCHCCIDLEFSM_H_
#define SMALLMGCHCCIDLEFSM_H_

#include "smallmgchccfsm.h"

class SmallMGC_HCC_IdleFsm : public SmallMgc_HCC_Fsm
{
public:
  static SmallMGC_HCC_IdleFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_HCC_IdleFsm* s_instance;
   SmallMGC_HCC_IdleFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMgc_HCC_Fsm(database, adapter)
     {

     };

   SmallMGC_HCC_IdleFsm();
   virtual ~SmallMGC_HCC_IdleFsm();
