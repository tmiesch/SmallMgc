...
SmallMGC_HCC_ModemEstablishedFsm::SmallMGC_HCC_ModemEstablishedFsm()
{
...
SmallMGC_HCC_ModemEstablishedFsm*  SmallMGC_HCC_ModemEstablishedFsm::s_instance = 0;

SmallMGC_HCC_ModemEstablishedFsm*  SmallMGC_HCC_ModemEstablishedFsm::instance(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter)
{
  if(s_instance == 0)
  {
    Poco::UInt32 xcode;
    s_instance = new SmallMGC_HCC_ModemEstablishedFsm(database, adapter);
  }
  return s_instance;
}


Poco::UInt32 SmallMGC_HCC_ModemEstablishedFsm::startCall(class H248STACK_Call* call, Poco::UInt32 transactionId, std::string& term )
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_HCC_ModemEstablishedFsm::modifyReply(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_HCC_ModemEstablishedFsm::modifyReply(class H248STACK_Call* call, enum SmallMGCLegDirection direction, std::string& localSDP)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_HCC_ModemEstablishedFsm::addReply(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_HCC_ModemEstablishedFsm::addReply(class H248STACK_Call* call, enum SmallMGCLegDirection direction, std::string& localSDP)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_HCC_ModemEstablishedFsm::subtractReply(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_HCC_ModemEstablishedFsm::notifyDigit(class H248STACK_Call* call, enum SmallMGCLegDirection direction, std::string& digits)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_HCC_ModemEstablishedFsm::notifyOffHook(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
  Application::instance().logger().trace(" State: HCC ModemEstablished;  Event:  notify off hook\n");
}
Poco::UInt32 SmallMGC_HCC_ModemEstablishedFsm::notifyOnHook(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_HCC_ModemEstablishedFsm::notifyTone(class H248STACK_Call* call, enum SmallMGCLegDirection direction, std::string& tones)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_HCC_ModemEstablishedFsm::notifyFlashHook(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_HCC_ModemEstablishedFsm::timerExpiry(class H248STACK_Call* call, enum SmallMGCLegDirection direction, Poco::UInt32 transactionId,std::string& term)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_HCC_ModemEstablishedFsm::startCallReq(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_HCC_ModemEstablishedFsm::bearerInformationReq(class H248STACK_Call* call, enum SmallMGCLegDirection direction, std::string& sdp)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_HCC_ModemEstablishedFsm::establishedReq(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
  Application::instance().logger().trace(" State: HCC ModemEstablished;  Event:  ModemEstablished req\n");
  return xcode;
}
Poco::UInt32 SmallMGC_HCC_ModemEstablishedFsm::releaseReq(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_HCC_ModemEstablishedFsm::ringingReq(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
  Application::instance().logger().trace(" State: HCC ModemEstablished;  Event:  ringing req\n");
  return xcode;
}
Poco::UInt32 SmallMGC_HCC_ModemEstablishedFsm::switchToT38Req(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_HCC_ModemEstablishedFsm::switchToModemReq(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_HCC_ModemEstablishedFsm::setup(class H248STACK_Call* call, enum SmallMGCLegDirection direction, enum SmallMGCIsdnBABearer bearer)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_HCC_ModemEstablishedFsm::information(class H248STACK_Call* call, enum SmallMGCLegDirection direction, std::string& number)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_HCC_ModemEstablishedFsm::alerting(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_HCC_ModemEstablishedFsm::connect(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_HCC_ModemEstablishedFsm::connectAck(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_HCC_ModemEstablishedFsm::disconnect(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_HCC_ModemEstablishedFsm::release(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
...
Poco::UInt32 SmallMGC_HCC_ModemEstablishedFsm::releaseComplete(class H248STACK_Call* call, enum SmallMGCLegDirection direction)
{
  Poco::UInt32 xcode = 0;
 ...
 Poco::UInt32 SmallMGC_HCC_ModemEstablishedFsm::sendToMg(std::string const& msg)
 {
   // for reply messages
 }
