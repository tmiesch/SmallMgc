...
#ifndef SMALLMGCHCCCHANGEFAXFSM_H_
#define SMALLMGCHCCCHANGEFAXFSM_H_


#include "smallmgchccfsm.h"

class SmallMGC_HCC_ChangeFaxFsm : public SmallMgc_HCC_Fsm
{
public:
  static SmallMGC_HCC_ChangeFaxFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_HCC_ChangeFaxFsm* s_instance;
   SmallMGC_HCC_ChangeFaxFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMgc_HCC_Fsm(database, adapter)
     {

     };
     SmallMGC_HCC_ChangeFaxFsm();
  virtual ~SmallMGC_HCC_ChangeFaxFsm();
...
#endif /* SMALLMGCHCCCHANGEFAXFSM_H_ */
