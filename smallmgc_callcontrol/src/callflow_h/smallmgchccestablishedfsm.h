...
#ifndef SMALLMGCHCCESTABLISHEDFSM_H_
#define SMALLMGCHCCESTABLISHEDFSM_H_

#include "smallmgchccfsm.h"

class SmallMGC_HCC_EstablishedFsm : public SmallMgc_HCC_Fsm
{
public:
  static SmallMGC_HCC_EstablishedFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_HCC_EstablishedFsm* s_instance;
   SmallMGC_HCC_EstablishedFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMgc_HCC_Fsm(database, adapter)
     {

     };
  SmallMGC_HCC_EstablishedFsm();
  virtual ~SmallMGC_HCC_EstablishedFsm();
...
#endif /* SMALLMGCHCCESTABLISHEDFSM_H_ */
