...
#ifndef SMALLMGCHCCCHANGEMODEMFSM_H_
#define SMALLMGCHCCCHANGEMODEMFSM_H_

#include "smallmgchccfsm.h"

class SmallMGC_HCC_ChangeModemFsm : public SmallMgc_HCC_Fsm
{
public:
  static SmallMGC_HCC_ChangeModemFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_HCC_ChangeModemFsm* s_instance;
   SmallMGC_HCC_ChangeModemFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMgc_HCC_Fsm(database, adapter)
     {

     };
     SmallMGC_HCC_ChangeModemFsm();
  virtual ~SmallMGC_HCC_ChangeModemFsm();
...
#endif /* SMALLMGCHCCCHANGEMODEMFSM_H_ */
