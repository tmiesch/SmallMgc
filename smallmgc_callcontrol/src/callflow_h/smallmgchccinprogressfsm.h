...
#ifndef SMALLMGCHCCINPROGRESSFSM_H_
#define SMALLMGCHCCINPROGRESSFSM_H_

#include "smallmgchccfsm.h"

class SmallMGC_HCC_InProgressFsm : public SmallMgc_HCC_Fsm
{
public:
  static SmallMGC_HCC_InProgressFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_HCC_InProgressFsm* s_instance;
   SmallMGC_HCC_InProgressFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMgc_HCC_Fsm(database, adapter)
     {

     };
  SmallMGC_HCC_InProgressFsm();
  virtual
  ~SmallMGC_HCC_InProgressFsm();
...
#endif /* SMALLMGCHCCINPROGRESSFSM_H_ */
