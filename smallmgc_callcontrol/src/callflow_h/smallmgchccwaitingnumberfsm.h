...
#ifndef SMALLMGCHCCWAITINGNUMBERFSM_H_
#define SMALLMGCHCCWAITINGNUMBERFSM_H_

#include "smallmgchccfsm.h"

class SmallMGC_HCC_WaitingNumberFsm : public SmallMgc_HCC_Fsm
{
public:
  static SmallMGC_HCC_WaitingNumberFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_HCC_WaitingNumberFsm* s_instance;
   SmallMGC_HCC_WaitingNumberFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMgc_HCC_Fsm(database, adapter)
     {

     };

     SmallMGC_HCC_WaitingNumberFsm();
  virtual ~SmallMGC_HCC_WaitingNumberFsm();
public:
...
#endif /* SMALLMGCHCCWAITINGNUMBERFSM_H_ */
