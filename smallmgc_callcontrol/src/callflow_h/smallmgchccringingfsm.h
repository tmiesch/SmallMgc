...
#ifndef SMALLMGCHCCRINGINGFSM_H_
#define SMALLMGCHCCRINGINGFSM_H_

#include "smallmgchccfsm.h"

class SmallMGC_HCC_RingingFsm : public SmallMgc_HCC_Fsm
{
public:
  static SmallMGC_HCC_RingingFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_HCC_RingingFsm* s_instance;
   SmallMGC_HCC_RingingFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMgc_HCC_Fsm(database, adapter)
     {

     };
  SmallMGC_HCC_RingingFsm();
  virtual
  ~SmallMGC_HCC_RingingFsm();
...
#endif /* SMALLMGCPCCRINGINGFSM_H_ */
