...
#ifndef SMALLMGCHCCFAXESTABLISHEDFSM_H_
#define SMALLMGCHCCFAXESTABLISHEDFSM_H_

#include "smallmgchccfsm.h"

class SmallMGC_HCC_FaxEstablishedFsm : public SmallMgc_HCC_Fsm
{
public:
  static SmallMGC_HCC_FaxEstablishedFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_HCC_FaxEstablishedFsm* s_instance;
   SmallMGC_HCC_FaxEstablishedFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMgc_HCC_Fsm(database, adapter)
     {

     };
  SmallMGC_HCC_FaxEstablishedFsm();
  virtual ~SmallMGC_HCC_FaxEstablishedFsm();
...
#endif /* SMALLMGCHCCFAXESTABLISHEDFSM_H_ */
