...
#ifndef SMALLMGCHCCSTARTEDFSM_H_
#define SMALLMGCHCCSTARTEDFSM_H_

#include "smallmgchccfsm.h"

class SmallMGC_HCC_StartedFsm : public SmallMgc_HCC_Fsm
{
public:
  static SmallMGC_HCC_StartedFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_HCC_StartedFsm* s_instance;
   SmallMGC_HCC_StartedFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMgc_HCC_Fsm(database, adapter)
     {

     };

  SmallMGC_HCC_StartedFsm();
  virtual ~SmallMGC_HCC_StartedFsm();
public:
...
#endif /* SMALLMGCPCCSTARTEDFSM_H_ */
