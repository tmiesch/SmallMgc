...
#ifndef SMALLMGCACCRELEASINGFSM_H_
#define SMALLMGCACCRELEASINGFSM_H_

#include "smallmgcaccfsm.h"

class SmallMGC_ACC_ReleasingFsm : public SmallMgc_ACC_Fsm
{
public:
  static SmallMGC_ACC_ReleasingFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_ACC_ReleasingFsm* s_instance;
   SmallMGC_ACC_ReleasingFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMgc_ACC_Fsm(database, adapter)
     {

     };
     SmallMGC_ACC_ReleasingFsm();
  virtual ~SmallMGC_ACC_ReleasingFsm();
...
#endif /* SMALLMGCACCRELEASINGFSM_H_ */
