...
#ifndef SMALLMGCACCSTARTEDFSM_H_
#define SMALLMGCACCSTARTEDFSM_H_

#include "smallmgcaccfsm.h"

class SmallMGC_ACC_StartedFsm : public SmallMgc_ACC_Fsm
{
public:
  static SmallMGC_ACC_StartedFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_ACC_StartedFsm* s_instance;
   SmallMGC_ACC_StartedFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMgc_ACC_Fsm(database, adapter)
     {

     };

  SmallMGC_ACC_StartedFsm();
  virtual ~SmallMGC_ACC_StartedFsm();
public:
...
#endif /* SMALLMGCACCSTARTEDFSM_H_ */
