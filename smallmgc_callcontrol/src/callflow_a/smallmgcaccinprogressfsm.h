...
#ifndef SMALLMGCACCINPROGRESSFSM_H_
#define SMALLMGCACCINPROGRESSFSM_H_

#include "smallmgcaccfsm.h"

class SmallMGC_ACC_InProgressFsm : public SmallMgc_ACC_Fsm
{
public:
  static SmallMGC_ACC_InProgressFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_ACC_InProgressFsm* s_instance;
   SmallMGC_ACC_InProgressFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMgc_ACC_Fsm(database, adapter)
     {

     };
  SmallMGC_ACC_InProgressFsm();
  virtual
  ~SmallMGC_ACC_InProgressFsm();
...
#endif /* SMALLMGCACCINPROGRESSFSM_H_ */
