...
#ifndef SMALLMGCACCIDLEFSM_H_
#define SMALLMGCACCIDLEFSM_H_

#include "smallmgcaccfsm.h"

class SmallMGC_ACC_IdleFsm : public SmallMgc_ACC_Fsm
{
public:
  static SmallMGC_ACC_IdleFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_ACC_IdleFsm* s_instance;
   SmallMGC_ACC_IdleFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMgc_ACC_Fsm(database, adapter)
     {

     };

   SmallMGC_ACC_IdleFsm();
   virtual ~SmallMGC_ACC_IdleFsm();
