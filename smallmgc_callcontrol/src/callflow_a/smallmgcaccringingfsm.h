...
#ifndef SMALLMGCACCRINGINGFSM_H_
#define SMALLMGCACCRINGINGFSM_H_

#include "smallmgcaccfsm.h"

class SmallMGC_ACC_RingingFsm : public SmallMgc_ACC_Fsm
{
public:
  static SmallMGC_ACC_RingingFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_ACC_RingingFsm* s_instance;
   SmallMGC_ACC_RingingFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMgc_ACC_Fsm(database, adapter)
     {

     };
  SmallMGC_ACC_RingingFsm();
  virtual
  ~SmallMGC_ACC_RingingFsm();
...
#endif /* SMALLMGCACCRINGINGFSM_H_ */
