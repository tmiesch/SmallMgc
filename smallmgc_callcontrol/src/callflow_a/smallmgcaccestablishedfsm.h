...
#ifndef SMALLMGCACCESTABLISHEDFSM_H_
#define SMALLMGCACCESTABLISHEDFSM_H_

#include "smallmgcaccfsm.h"

class SmallMGC_ACC_EstablishedFsm : public SmallMgc_ACC_Fsm
{
public:
  static SmallMGC_ACC_EstablishedFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_ACC_EstablishedFsm* s_instance;
   SmallMGC_ACC_EstablishedFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMgc_ACC_Fsm(database, adapter)
     {

     };
  SmallMGC_ACC_EstablishedFsm();
  virtual ~SmallMGC_ACC_EstablishedFsm();
...
#endif /* SMALLMGCACCESTABLISHEDFSM_H_ */
