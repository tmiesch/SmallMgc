...
#ifndef SMALLMGCCCFSM_H_
#define SMALLMGCCCFSM_H_

#include "Poco/Types.h"
#include "h248stack_database.h"


class SmallMGC_CC_Fsm
{
    //static   SmallMGC_CC_Fsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
public :
  SmallMGC_CC_Fsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter);
  virtual ~SmallMGC_CC_Fsm();
  SmallMGC_CC_Fsm();

  //static   SmallMGC_CC_Fsm* s_instance;
...
public :
 ...
 virtual Poco::UInt32 timerExpiry(class H248STACK_Call* call, enum SmallMGCLegDirection direction);                             //C,F
 ...
 virtual Poco::UInt32 sipInvite(class H248STACK_Call* call, enum SmallMGCLegDirection direction, enum SmallMGCIsdnBABearer bearer);
 virtual Poco::UInt32 sipTimeout(class H248STACK_Call* call, enum SmallMGCLegDirection direction, std::string& number);
 virtual Poco::UInt32 sipRegister(class H248STACK_Call* call, enum SmallMGCLegDirection direction);
 virtual Poco::UInt32 sipAck(class H248STACK_Call* call, enum SmallMGCLegDirection direction);
 virtual Poco::UInt32 sipCancel(class H248STACK_Call* call, enum SmallMGCLegDirection direction);
 virtual Poco::UInt32 sipBye(class H248STACK_Call* call, enum SmallMGCLegDirection direction);
 virtual Poco::UInt32 sipNotify(class H248STACK_Call* call, enum SmallMGCLegDirection direction);
 virtual Poco::UInt32 sipRefer(class H248STACK_Call* call, enum SmallMGCLegDirection direction);
 virtual Poco::UInt32 sipOptions(class H248STACK_Call* call, enum SmallMGCLegDirection direction);
 virtual Poco::UInt32 sipSubscribe(class H248STACK_Call* call, enum SmallMGCLegDirection direction);
