...
#ifndef SMALLMGCISDNCCRELEASINGFSM_H_
#define SMALLMGCISDNCCRELEASINGFSM_H_

#include "smallmgcisdnccfsm.h"

class SmallMGC_IsdnCC_ReleasingFsm : public SmallMGC_IsdnCC_Fsm
{
public:
  static SmallMGC_IsdnCC_ReleasingFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_IsdnCC_ReleasingFsm* s_instance;
   SmallMGC_IsdnCC_ReleasingFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMGC_IsdnCC_Fsm(database, adapter)
     {

     };

  SmallMGC_IsdnCC_ReleasingFsm();
  virtual
  ~SmallMGC_IsdnCC_ReleasingFsm();
public:
...
#endif /* SMALLMGCIsdnCCRELEASINGFSM_H_ */
