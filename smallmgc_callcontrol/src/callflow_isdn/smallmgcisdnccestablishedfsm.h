...
#ifndef SMALLMGCISDNCCESTABLISHEDFSM_H_
#define SMALLMGCISDNCCESTABLISHEDFSM_H_

#include "smallmgcisdnccfsm.h"

class SmallMGC_IsdnCC_EstablishedFsm : public SmallMGC_IsdnCC_Fsm
{
public:
  static SmallMGC_IsdnCC_EstablishedFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_IsdnCC_EstablishedFsm* s_instance;
   SmallMGC_IsdnCC_EstablishedFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMGC_IsdnCC_Fsm(database, adapter)
     {

     };

  SmallMGC_IsdnCC_EstablishedFsm();
  virtual
  ~SmallMGC_IsdnCC_EstablishedFsm();
public:
...
#endif /* SMALLMGCIsdnCCESTABLISHEDFSM_H_ */
