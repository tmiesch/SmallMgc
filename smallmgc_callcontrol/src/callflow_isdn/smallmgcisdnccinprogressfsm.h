...
#ifndef SMALLMGCISDNCCINPROGRESSFSM_H_
#define SMALLMGCISDNCCINPROGRESSFSM_H_

#include "smallmgcisdnccfsm.h"

class SmallMGC_IsdnCC_InProgressFsm : public SmallMGC_IsdnCC_Fsm
{
public:
  static SmallMGC_IsdnCC_InProgressFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_IsdnCC_InProgressFsm* s_instance;
   SmallMGC_IsdnCC_InProgressFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMGC_IsdnCC_Fsm(database, adapter)
     {

     };

  SmallMGC_IsdnCC_InProgressFsm();
  virtual
  ~SmallMGC_IsdnCC_InProgressFsm();
...
#endif /* SMALLMGCIsdnCCINPROGRESSFSM_H_ */
