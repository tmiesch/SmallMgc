...
#ifndef SMALLMGCISDNCCWAITINGNUMBERFSM_H_
#define SMALLMGCISDNCCWAITINGNUMBERFSM_H_

#include "smallmgcisdnccfsm.h"

class SmallMGC_IsdnCC_WaitingNumberFsm : public SmallMGC_IsdnCC_Fsm
{
public:
  static SmallMGC_IsdnCC_WaitingNumberFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_IsdnCC_WaitingNumberFsm* s_instance;
   SmallMGC_IsdnCC_WaitingNumberFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMGC_IsdnCC_Fsm(database, adapter)
     {

     };
  SmallMGC_IsdnCC_WaitingNumberFsm();
  virtual
  ~SmallMGC_IsdnCC_WaitingNumberFsm();
public:
...
#endif /* SMALLMGCIsdnCCWAITINGNUMBERFSM_H_ */
