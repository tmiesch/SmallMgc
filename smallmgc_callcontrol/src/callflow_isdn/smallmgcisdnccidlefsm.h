...
#ifndef SMALLMGCISDNCCIDLEFSM_H_
#define SMALLMGCISDNCCIDLEFSM_H_

#include "smallmgcisdnccfsm.h"

class SmallMGC_IsdnCC_IdleFsm : public SmallMGC_IsdnCC_Fsm
{
public:
  static SmallMGC_IsdnCC_IdleFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_IsdnCC_IdleFsm* s_instance;
   SmallMGC_IsdnCC_IdleFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMGC_IsdnCC_Fsm(database, adapter)
     {

     };

  SmallMGC_IsdnCC_IdleFsm();
  virtual ~SmallMGC_IsdnCC_IdleFsm();
...
#endif /* SMALLMGCIsdnCCIDLEFSM_H_ */
