...
#ifndef SMALLMGCISDNCCSTARTEDFSM_H_
#define SMALLMGCISDNCCSTARTEDFSM_H_

#include "smallmgcisdnccfsm.h"

class SmallMGC_IsdnCC_StartedFsm : public SmallMGC_IsdnCC_Fsm
{
public:
  static SmallMGC_IsdnCC_StartedFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_IsdnCC_StartedFsm* s_instance;
   SmallMGC_IsdnCC_StartedFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMGC_IsdnCC_Fsm(database, adapter)
     {

     };

  SmallMGC_IsdnCC_StartedFsm();
  virtual  ~SmallMGC_IsdnCC_StartedFsm();
...
#endif /* SMALLMGCIsdnCCSTARTEDFSM_H_ */
