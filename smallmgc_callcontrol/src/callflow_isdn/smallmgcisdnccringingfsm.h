...
#ifndef SMALLMGCISDNCCRINGINGFSM_H_
#define SMALLMGCISDNCCRINGINGFSM_H_

#include "smallmgcisdnccfsm.h"

class SmallMGC_IsdnCC_RingingFsm : public SmallMGC_IsdnCC_Fsm
{
public:
  static SmallMGC_IsdnCC_RingingFsm* instance(class H248STACK_Database* database=0, class H248STACK_CallAdapter* adapter=0);
private :
   static SmallMGC_IsdnCC_RingingFsm* s_instance;
   SmallMGC_IsdnCC_RingingFsm(class H248STACK_Database* database, class H248STACK_CallAdapter* adapter):
     SmallMGC_IsdnCC_Fsm(database, adapter)
     {

     };
  SmallMGC_IsdnCC_RingingFsm();
  virtual ~SmallMGC_IsdnCC_RingingFsm();
public:
...
#endif /* SMALLMGCIsdnCCRINGINGFSM_H_ */
