...
private:
  ...
  void parseAction(class CActions *actions);
  void handle_arithmetic(class CAction *tmpAction, char *what);
  void handle_rhs(class CAction *tmpAction, char *what);
