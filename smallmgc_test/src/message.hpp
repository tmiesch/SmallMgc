...
typedef enum {
  ...
  E_Message_TransactionType,
  E_Message_TransactionNumber,
  E_Message_Context,
  E_Message_PhysicalTermination,
  E_Message_EphemeralTermination,
  E_Message_Termination,
  E_Message_LocalSDP,
  E_Message_RemoteSDP,
  E_Message_EventNumber,
  E_Message_Branch,
  E_Message_Len,
  E_Message_Variable,
  E_Message_Fill,
...
#include "call.hpp"
//class call;
typedef int (*customKeyword)(class call *, struct MessageComponent *, char *, int);
