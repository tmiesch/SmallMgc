...
#include <iostream>
std::string SDPSTACK_Parser::sdpMesg;
std::string SDPSTACK_Parser::m_sdpParserTest;
...
H248STACK_Commands* SDPSTACK_Parser::s_command = 0;
H248STACK_Commands* SDPSTACK_Parser::s_firstCommand = 0;

SDPSTACK_Parser::SDPSTACK_Parser() : message_(new H248STACK_Message)
{
}


void SDPSTACK_Parser::setMessage(char* mesg)
{
  SDPSTACK_Parser::sdpMesg.clear();
  SDPSTACK_Parser::sdpMesg.assign(mesg);
}

void SDPSTACK_Parser::setSdpParserTest(int start, int len)
{
  SDPSTACK_Parser::m_sdpParserTest.assign( SDPSTACK_Parser::sdpMesg.substr(start, len));
